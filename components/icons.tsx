...
export const DeleteIcon = createSvgIcon(
  <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.057.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />,
  { defaultClassName: 'w-5 h-5' }
);
...
export const SettingsIcon = createSvgIcon(
  <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.085 1.11-1.226l.548-.092a5.204 5.204 0 0 1 3.58 3.58l.092.548c.09.542.56.95 1.108 1.168.55.218 1.19.218 1.74 0 .55-.218 1.02-.684 1.11-1.226l.092-.548a5.204 5.204 0 0 1 3.58-3.58l.548-.092c.542-.09.95-.56 1.168-1.11.218-.55.218-1.19 0-1.742-.218-.558-.684-1.02-1.226-1.11l-.548-.092a5.204 5.204 0 0 1-3.58-3.58l-.092-.548c-.09-.542-.56-.95-1.11-1.168-.55-.218-1.192 0-1.742.218-.558.684-1.02 1.226-1.11l.548-.092a5.204 5.204 0 0 1 3.58-3.58l.092-.548zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />,
  { defaultClassName: 'w-6 h-6' }
);

export const HistoryIcon = createSvgIcon(
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 0 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18c-2.305 0-4.408.867-6 2.292m0-14.25v14.25" />,
  { defaultClassName: 'w-6 h-6' }
);

export const KeyIcon = createSvgIcon(
  <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.562-.967.43-1.563A6 6 0 1 1 21.75 8.25Z" />,
  { defaultClassName: 'w-5 h-5' }
);
...
export const GoogleDriveIcon = createSvgIcon(
  <>
    <path d="M19.152,8.691,15.36,2.337a.644.644,0,0,0-.561-.337H8.973a.644.644,0,0,0-.561.337L4.62,8.691A.646.646,0,0,0,4,9.028v.019l3.8,6.619,3.784-6.6,3.792,6.6,3.8-6.619v-.019A.646.646,0,0,0,19.152,8.691Z" fill="#3777e3"/>
    <path d="M12.02,15.644,7.868,8.4,4.062,15.025a.643.643,0,0,0,.327.886l7.3,4.218a.643.643,0,0,0,.646,0l7.3-4.218a.643.643,0,0,0,.327-.886L16.172,8.4Z" fill="#ffc107"/>
    <path d="M8.188,8.082,4.392,1.428a.644.644,0,0,0-.561-.337H1.533a.644.644,0,0,0-.561.337L.028,2.788a.644.644,0,0,0,.2,1.134L8.188,8.082Z" fill="#1da153"/>
  </>,
  { defaultClassName: 'w-6 h-6', fill: 'currentColor', stroke: 'none' }
);

export const WhatsAppIcon = createSvgIcon(
  <path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91C2.13 13.66 2.61 15.31 3.45 16.76L2.05 22L7.3 20.62C8.7 21.39 10.32 21.82 12.04 21.82C17.5 21.82 21.95 17.37 21.95 11.91C21.95 6.45 17.5 2 12.04 2M12.04 3.67C16.56 3.67 20.28 7.38 20.28 11.91C20.28 16.44 16.56 20.15 12.04 20.15C10.46 20.15 8.96 19.75 7.64 19.05L7.26 18.83L4.93 19.5L5.64 17.25L5.42 16.85C4.66 15.48 4.22 13.77 4.22 11.91C4.22 7.38 7.93 3.67 12.04 3.67M17.38 14.52C17.21 14.43 16.14 13.92 15.94 13.85C15.73 13.78 15.59 13.74 15.44 13.95C15.29 14.15 14.79 14.71 14.64 14.86C14.49 15.01 14.35 15.04 14.04 14.9C13.73 14.76 12.89 14.48 11.89 13.61C11.11 12.92 10.59 12.11 10.44 11.87C10.29 11.62 10.4 11.5 10.52 11.38C10.63 11.27 10.76 11.1 10.88 10.95C11 10.8 11.05 10.68 11.15 10.48C11.25 10.28 11.2 10.11 11.13 9.96C11.06 9.81 10.63 8.79 10.46 8.35C10.29 7.91 10.11 7.95 7.94H9.6C9.45 7.94 9.18 8.01 8.94 8.26C8.7 8.5 8.1 9.04 8.1 10.2C8.1 11.36 8.98 12.45 9.11 12.6C9.24 12.75 10.63 15.03 12.91 15.93C13.79 16.29 14.43 16.45 14.93 16.59C15.65 16.79 16.25 16.73 16.71 16.4C17.23 16.03 17.84 15.34 18.01 14.95C18.18 14.56 18.18 14.23 18.11 14.11C18.05 13.98 17.55 14.71 17.38 14.52Z"/>,
  { defaultClassName: 'w-5 h-5', fill: 'currentColor', stroke: 'none' }
);
...
export const ClipboardDocumentListIcon = createSvgIcon(
  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 5.25 6h.832a48.49 48.49 0 0 1 1.123-.08m8.691 12.75a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25V6.108c0-1.135.845-2.098 1.976-2.192a48.424 48.424 0 0 1 1.123-.08" />,
  { defaultClassName: 'w-5 h-5' }
);
...
export const RenewIcon = createSvgIcon(
  <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-11.667-11.667a8.25 8.25 0 0 0-11.667 0l-3.181 3.183m11.667 11.667v-4.992" />,
  { defaultClassName: 'w-5 h-5' }
);